...
class ScopedSymbolTable:
    """Namespaces"""
    def __init__(self, scope_name, scope_level, enclosing_scope=None, _SHOULD_LOG_SCOPE=False):
        self._symbols = {}
        self.scope_name = scope_name
        self.scope_level = scope_level
        self.enclosing_scope = enclosing_scope
        self._SHOULD_LOG_SCOPE = _SHOULD_LOG_SCOPE
...
class SemanticAnalyzer(NodeVisitor):
    def __init__(self, _SHOULD_LOG_SCOPE=False):
    ...
    def visit_Program(self, node):
        ...
        global_scope = ScopedSymbolTable(
            ...
            _SHOULD_LOG_SCOPE = self._SHOULD_LOG_SCOPE,
        )
